...
const DEFAULT_CAPABILITIES = {
  ...
  zcode: {
    billing: "subscription",
    priority: "preferred",
    note: "ZCode running GLM-5.2 (z.ai Coding Plan) — cheap subscription. Best for BOUNDED coding sub-tasks (a few files, bug fix, tests, chinese text). Do NOT send heavy multi-file / long agentic reviews: bursts trip z.ai's 1302 rate-limit whose retry loop then burns the whole timeout with zero output — route those to codex. Do NOT use for non-coding work (strategy / prose brainstorming): z.ai actively bans non-coding use of the Coding Plan. GLM-5.2 also costs 3x quota at peak 14:00-18:00 UTC+8.",
