...
const STRINGS = {
  en: {
    ...
    "agents.usage":            "Usage: /agents [enable|disable|model|add|remove] [key] [value]",
    ...
    "discuss.judge_checking":  "\n[All suggested converge, consulting judge...]",
    "discuss.judge_no":        "[Judge] Not yet converged — {reason}",
    ...
    "discuss.summarising":     "[Generating progress summary...]",
...
You are {name} (speaker {pos}/{total}, round {round}). First respond to others' points (agree, question, or add), then judge whether convergence is reached. If the core disagreements are resolved and nothing new remains, add [STOP] at the end. Concise (under 150 words).`,
  ...
  zh: {
    ...
    "agents.usage":            "用法: /agents [enable|disable|model|add|remove] [key] [value]",
    ...
    "discuss.judge_checking":  "\n[全员建议收敛，交由裁判确认...]",
    "discuss.judge_no":        "[裁判] 尚未收敛 — {reason}",
    "discuss.max_rounds":      "\n⚠️  达到最大轮数 ({n})",
    "discuss.max_turns":       "\n⚠️  达到最大轮次 ({n})",
    "discuss.stop_sent":       "\n[停止信号已发送，等待当前步骤完成...]",
    "discuss.interjected":     "[已记录，下一位 agent 将看到你的输入]",
    "discuss.summarising":     "[正在生成当前进度摘要...]",
