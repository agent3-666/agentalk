...
const DEFAULT_AGENTS = [
  ...
  },
  {
    ...
    name: "ZCode",
    cmd: "zcode",
    args: ["--prompt", "{prompt}", "--mode", "yolo", "--no-color"],
    color: "#6C5CE7",
    output: "text",
    enabled: true,
    model: null,
    note: "ZCode CLI (z.ai GLM Coding Plan, native harness). Model is configured in ~/.zcode/cli/config.json. Needs a `zcode` wrapper on PATH backed by Node 22.5+ (the CLI uses node:sqlite). See comment above for setup.",
  },
  {
    key: "opencode",
    name: "OpenCode",
